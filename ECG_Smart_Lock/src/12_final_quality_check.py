...
def evaluate_beats(
    ...
    # Median Template
    #
    # از Median استفاده می‌کنیم چون نسبت به Artifact
    # مقاوم‌تر از Mean است.
    # -----------------------------------------------------
    ...
    # -----------------------------------------------------
    # Correlation هر Beat با Template
    # -----------------------------------------------------
    ...
    #
    # معیار مقاوم برای تشخیص Outlier
    # -----------------------------------------------------
